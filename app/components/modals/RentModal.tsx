...
const RentModal = () => {
	...
	if (step === STEPS.LOCATION) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				<Heading title="Which of this best describe your place?" subtitle="Pick a category"/>
	...
	if (step === STEPS.INFO) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				...
				<Counter title="Guests" subtitle="How many guests do you allow?" onChange={(value) => setCustomValue('guestCount', value)} value={guestCount} />
				<hr />
	...
	if (step === STEPS.DESCRIPTION) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				<Heading title="How would you describe your place?" subtitle="Short and sweet best!" />
